...
func main() {
	...
	RelayHost, err = libp2p.New(
		...
		libp2p.ListenAddrStrings("/ip4/0.0.0.0/tcp/8080/ws"),
	...
	OwnRelayAddrFull = fmt.Sprintf("/dns4/libr-902134270448.asia-south1.run.app/tcp/443/wss/p2p/%s", RelayHost.ID().String())
	err = ConnectJSServer()
	if err != nil {
